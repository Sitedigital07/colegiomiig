...
<div class="container">
                                ...
                                <div class="block">
                                    ...
                                    {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('/editarsector',$sectores->id))) }}
                                       
                                      
                                         <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Region</label>
                                            <div class="col-md-9">
                                               {{Form::text('region', $sectores->region, array('class' => 'form-control','placeholder'=>''))}}
                                            </div>
                                        </div>
