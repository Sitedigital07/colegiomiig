                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Informe</strong> Títulos</h2>
                                    </div>
                                    <!-- END Form Elements Title -->
                                    
                                    <!-- Basic Form Elements Content -->
                                     {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('/informe/titulos'))) }}


                                  
                                       
                                       <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Representantes</label>
                                            <div class="col-md-9">
