...
<div id="primero" class="element" style="display: none;">
  ...
  {{ Form::open(array('method' => 'POST', 'id' => 'defaultForm', 'url' => array('/crearproducto'))) }}
  ...
  <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="1a" class="element" hidden>
 ...
 <input id="id_input" type="text" hidden>
  ...
  <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="1b" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
  ...
  <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="1c" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 1)
  ...
  <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="1d" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 1)
  ...
  <h4><b>IG</b> - Interes General</h4>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
     <select class="form-control input-sm" name="edt[]" id="category1e" required="required">
      ...
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="1e" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 1)
  ...
  <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="1f" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 1)
 ...
 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
  ...
  <h4><b>ING</b> - Ingles</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="1g" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 1)
...
<div id="segundo" class="element" style="display: none;">
  ...
  <h4><b>MT</b> - Matematicas</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="2a" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 2)
  ...
  <h4><b>ES</b> - Español</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="2b" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 2)
  ...
  <h4><b>CS</b> - Sociales</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="2c" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 2)
  ...
  <h4><b>CL</b> - Comprensión Lectora</h4>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
     ...
     <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="2d" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 2)
  ...
  <h4><b>IG</b> - Interes General</h4>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
     ...
     <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="2e" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 2)
  ...
  <h4><b>ART</b> - Artistica</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="2f" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 2)
 ...
 <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="2g" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 2)
...
<div id="tercero" class="element" style="display: none;">
 ...
 <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="3a" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 3)
  ...
  <h4><b>ES</b> - Español</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="3b" class="element" hidden>
  ...
  <h4><b>CS</b> - Sociales</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="3c" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 3)
 ...
 <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="3d" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 3)
  ...
  <h4><b>IG</b> - Interes General</h4>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
     ...
     <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="3e" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 3)
 ...
 <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="3f" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 3)
 ...
 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
  ...
  <h4><b>ING</b> - Ingles</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="3g" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 3)
...
<div id="cuarto" class="element" style="display: none;">
  ...
  <h4><b>MT</b> - Matematicas</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    <select class="form-control input-sm" name="edt[]" id="category4a" required="required">
     ...
     <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="4a" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 4)
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    <select class="form-control input-sm" name="edt[]" id="category4b" required="required">
     <option value="" selected>Seleccione editorial</option>
      ...
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="4b" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 4)
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    <select class="form-control input-sm" name="edt[]" id="category4c" required="required">
     <option value="" selected>Seleccione editorial</option>
      ...
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="4c" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 4)
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
     <select class="form-control input-sm" name="edt[]" id="category4d" required="required">
      <option value="" selected>Seleccione editorial</option>
       ...
       <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="4d" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 4)
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
     <select class="form-control input-sm" name="edt[]" id="category4e" required="required">
      <option value="" selected>Seleccione editorial</option>
       ...
       <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="4e" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 4)
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    <select class="form-control input-sm" name="edt[]" id="category4f" required="required">
     <option value="" selected>Seleccione editorial</option>
      ...
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="4f" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 4)
 ...
 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
  ...
  <h4><b>ING</b> - Ingles</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="4g" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 4)
...
<div id="quinto" class="element" style="display: none;">
  ...
  <h4><b>MT</b> - Matematicas</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="5a" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 5)
  ...
  <h4><b>ES</b> - Español</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="5b" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 5)
  ...
  <h4><b>CS</b> - Sociales</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="5c" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 5)
  ...
  <h4><b>CL</b> - Comprensión Lectora</h4>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
     ...
     <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="5d" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 5)
  ...
  <h4><b>IG</b> - Interes General</h4>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
     ...
     <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="5e" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 5)
  ...
  <h4><b>ART</b> - Artistica</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="5f" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 5)
 ...
 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
  ...
  <h4><b>ING</b> - Ingles</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="5g" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 5)
...
<div id="sexto" class="element" style="display: none;">
  ...
  <h4><b>MT</b> - Matematicas</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="6a" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 6)
  ...
  <h4><b>ES</b> - Español</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="6b" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 6)
  ...
  <h4><b>CS</b> - Sociales</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="6c" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 6)
  ...
  <h4><b>CL</b> - Comprensión Lectora</h4>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="6d" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 6)
  ...
  <h4><b>IG</b> - Interes General</h4>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="6e" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 6)
  ...
  <h4><b>ART</b> - Artistica</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="6f" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 6)
 ...
 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
  ...
  <h4><b>ING</b> - Ingles</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="6g" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 6)
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    <select class="form-control input-sm" name="edt[]" id="category7a" required="required">
     <option value="" selected>Seleccione editorial</option>
      ...
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="7a" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 7)
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    <select class="form-control input-sm" name="edt[]" id="category7b" required="required">
     <option value="" selected>Seleccione editorial</option>
      ...
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="7b" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 7)
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    <select class="form-control input-sm" name="edt[]" id="category7c" required="required">
     <option value="" selected>Seleccione editorial</option>
      ...
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="7c" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 7)
      ...
      <option value="" selected>Seleccione editorial</option>
       @foreach($editorialf as $editorial)
        <option value="{{$editorial->id}}">{{$editorial->editorial}}</option>
          ...
          <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="7d" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 7)
     ...
     <select class="form-control input-sm" name="edt[]" id="category7e" required="required">
      <option value="" selected>Seleccione editorial</option>
       ...
       @endforeach
          ...
          <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="7e" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 7)
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    <select class="form-control input-sm" name="edt[]" id="category7f" required="required">
     <option value="" selected>Seleccione editorial</option>
      ...
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="7f" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 7)
    ...
    <select class="form-control input-sm" name="edt[]" id="category7g" required="required">
     <option value="" selected>Seleccione editorial</option>
      ...
      @endforeach
         ...
         <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="7g" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 7)
...
<div id="octavo" class="element" style="display: none;">
  ...
  <h4><b>MT</b> - Matematicas</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="8a" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 8)
 ...
 <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="8b" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 8)
  ...
  <h4><b>CS</b> - Sociales</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="8c" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 8)
  ...
  <h4><b>CL</b> - Comprensión Lectora</h4>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
     ...
     <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="8d" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 8)
  ...
  <h4><b>IG</b> - Interes General</h4>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
     ...
     <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="8e" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 8)
  ...
  <h4><b>ART</b> - Artistica</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="8f" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 8)
 ...
 <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="8g" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 8)
...
<div id="noveno" class="element" style="display: none;">
 ...
 <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="9a" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 9)
...
<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="9b" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 9)
...
<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="9c" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 9)
  ...
  <h4><b>CL</b> - Comprensión Lectora</h4>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="9d" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 9)
...
<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="9e" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 9)
  ...
  <h4><b>ART</b> - Artistica</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="9f" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 9)
 ...
 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
  ...
  <h4><b>ING</b> - Ingles</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="9g" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 9)
...
<div id="decimo" class="element" style="display: none;">
  ...
  <h4><b>MT</b> - Matematicas</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="10a" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required"> 
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 10)
  ...
  <h4><b>ES</b> - Español</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="10b" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 10)
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    <select class="form-control input-sm" name="edt[]" id="category10c" required="required">
     <option value="" selected>Seleccione editorial</option>
      ...
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="10c" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 10)
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
     <select class="form-control input-sm" name="edt[]" id="category10d" required="required">
      <option value="" selected>Seleccione editorial</option>
       ...
       <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="10d" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 10)
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
     <select class="form-control input-sm" name="edt[]" id="category10e" required="required">
      <option value="" selected>Seleccione editorial</option>
       ...
       <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="10e" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 10)
  ...
  <h4><b>ART</b> - Artistica</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="10f" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 10)
 ...
 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
  ...
  <h4><b>ING</b> - Ingles</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="10g" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 10)
...
<div id="once" class="element" style="display: none;">
  ...
  <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="11a" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 11)
  ...
  <h4><b>ES</b> - Español</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    <select class="form-control input-sm" name="edt[]" id="category11b" required="required">
     ...
     <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="11b" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 11)
  ...
  <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="11c" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 11)
  ...
  <h4><b>CL</b> - Comprensión Lectora</h4>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
     <select class="form-control input-sm" name="edt[]" id="category11d" required="required">
      ...
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="11d" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 11)
  ...
  <h4><b>IG</b> - Interes General</h4>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
     <select class="form-control input-sm" name="edt[]" id="category11e" required="required">
      ...
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="11e" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 11)
  ...
  <h4><b>ART</b> - Artistica</h4>
   ...
   <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    <select class="form-control input-sm" name="edt[]" id="category11f" required="required">
     ...
     <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="11f" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 11)
 ...
 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
  ...
  <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="11g" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required="required">
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 11)
...
<div id="prejardin" class="element" style="display: none;">
  ...
  <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="12h" class="element" hidden>
...
<div id="jardin" class="element" style="display: none;">
  ...
  <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="13i" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required/>
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 13)
...
<div id="transicion" class="element" style="display: none;">
  ...
  <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="14j" class="element" hidden>
    <select class="form-control input-sm" name="titulo[]" id="category" required/>
     <option value="0" selected>Seleccione editorial</option>
      @foreach($titulof as $titulo)
      @if($titulo->grado == 14)
